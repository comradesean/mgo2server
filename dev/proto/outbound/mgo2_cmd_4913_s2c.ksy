...
doc: |
  ...
  Wrapper `0xd4b5d0`: on a `-1` return from the shared parser it does nothing; otherwise it
  completes request-status slot **64** with the result via `0xD32E08`/`0xD32E70`.
