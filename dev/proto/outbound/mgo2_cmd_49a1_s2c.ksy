meta:
  ...
  title: "MGO2 0x49a1 — server -> client: team record (shared 0xD4AF34 layout)"
  endian: be
  encoding: ISO-8859-1
doc: |
  Evidence: GAME reply dispatcher `0xD387C8` (compare tree at `0xD38804`) matches `cmpwi 0x49a1` at `0xd38d34` and branches to the
