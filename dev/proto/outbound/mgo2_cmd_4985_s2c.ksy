...
doc: |
  ...
  Wrapper `0xd4b6b0`: on a `-1` return from the shared parser it does nothing; otherwise it
  completes request-status slot **63** with the result via `0xD32E08`/`0xD32E70`.
