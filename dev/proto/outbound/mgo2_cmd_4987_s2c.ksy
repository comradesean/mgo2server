...
doc: |
  ...
  Wrapper `0xd4d770` — **polarity corrected 2026-08-03; the previous statement here was
  ...
  alone), and ONLY a `-1` return completes request-status slot **72** with the result via `0xD32E08`/`0xD32E70`.
