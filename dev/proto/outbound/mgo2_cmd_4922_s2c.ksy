meta:
  ...
  encoding: ISO-8859-1
doc: |
  Evidence: GAME reply dispatcher `0xD387C8` (compare tree at `0xD38804`) matches `cmpwi 0x4922` at `0xd38c34` and branches to the
  thunk at `0xd39740`, which tail-calls the parser at `0xd4cff8`. Channel A (lobby TCP).
