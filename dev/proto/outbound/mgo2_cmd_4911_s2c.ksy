meta:
  id: mgo2_cmd_4911_s2c
  title: "MGO2 0x4911 — server -> client: team record (shared 0xD4AF34 layout)"
  endian: be
  encoding: ISO-8859-1
doc: |
  ...
  Wrapper `0xd4b720` — **polarity corrected 2026-08-03; the previous statement here was
  ...
  alone), and ONLY a `-1` return completes request-status slot **60** with the result via `0xD32E08`/`0xD32E70`.
