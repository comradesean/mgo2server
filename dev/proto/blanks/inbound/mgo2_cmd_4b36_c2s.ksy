meta:
  ...
  title: "MGO2 0x4b36 — clan/GHQ request (client -> server)"
  endian: be
doc: |
  ...
  (`li r4,0x4b36` in the preceding instruction); the ONLY payload write between the
  ...
  `0xD32E08(session, 108, 1)`. The sender does not name the reply id.
