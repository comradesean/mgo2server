meta:
  ...
  title: "MGO2 0x4b4c — clan/GHQ request (client -> server)"
  endian: be
doc: |
  ...
  (`li r4,0x4b4c` in the preceding instruction); the ONLY payload write between the
  ...
  `0xD32E08(session, 103, 1)`. The sender does not name the reply id.
