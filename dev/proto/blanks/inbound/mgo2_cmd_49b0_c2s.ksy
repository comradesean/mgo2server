...
doc: |
  ...
  Unhandled. Arguments r4 (`stw 1416(r1)`) and r5 (`stw 1424(r1)`), written in argument order.
...
seq:
  - id: unknown_00
    type: u4
    doc: "[ELF] `0xD5C9BC` at `0xD4A4E0`, source = sender arg r4. Meaning [UNKNOWN]."
  - id: unknown_04
    type: u4
    doc: "[ELF] `0xD5C9BC` at `0xD4A4F0`, source = sender arg r5. Meaning [UNKNOWN]."
