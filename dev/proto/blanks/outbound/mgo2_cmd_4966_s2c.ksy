meta:
  ...
  title: "MGO2 0x4966 — server -> client: clan notification carrying one 4-byte word"
  endian: be
  encoding: ISO-8859-1
doc: |
  Evidence: reply dispatcher `0xD38804` matches `cmpwi 0x4966` at `0xd38cc8` and branches to the
