...
doc: |
  ...
  Routing: dispatcher 0xD38804 (the 0x41xx-0x4Exx compare chain) -> thunk -> parser **0xD54F30**,
  ...
  Gate word at session[+0x10000+6404] + 0x20000 + 29724: must be NON-zero on arrival.
