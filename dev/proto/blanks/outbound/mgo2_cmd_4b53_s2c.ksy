meta:
  ...
  title: "MGO2 0x4b53 — clan/GHQ reply, single result code (server -> client) — list-triple START"
  endian: be
doc: |
  ...
  Routing: dispatcher 0xD38804 (the 0x41xx-0x4Exx compare chain) -> thunk -> parser **0xD554A4**,
