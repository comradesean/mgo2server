meta:
  ...
  encoding: ISO-8859-1
doc: |
  Evidence: reply dispatcher `0xD38804` matches `cmpwi 0x4987` at `0xd38cfc` and branches to the
...
seq:
  ...
  - id: block_204
    ...
    doc: |
      ...
      clan+0x0B0. Its internal layout is modelled as `block_204` in
      `mgo2_cmd_4909.ksy`; kept opaque here so the two files cannot drift.
  - id: members
    type: member
    repeat: expr
    repeat-expr: 8
