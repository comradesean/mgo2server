meta:
  ...
  title: "MGO2 0x4b93 — clan/GHQ reply, single result code (server -> client) — list-triple END"
  endian: be
doc: |
  ...
  Routing: dispatcher 0xD38804 (the 0x41xx-0x4Exx compare chain) -> thunk -> parser **0xD54CB0**,
