...
doc: |
  ...
  which is a two-instruction trampoline into the same shared handler **0xd35b68**:
    ...
    * GATE    dispatcher 0xd361e8, arm 0xd3624c -> `bl 0xd35b68` with `r4 = 0`
    * ACCOUNT dispatcher 0xd37074, arm 0xd370d8 -> `bl 0xd35b68` with `r4 = 1`
    * GAME    dispatcher 0xd38804, arm 0xd38ffc -> `bl 0xd35b68` with `r4 = 2`
