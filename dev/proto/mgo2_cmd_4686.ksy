meta:
  ...
  encoding: ISO-8859-1
doc: |
  Item packet of the 0x4684 match-detail triple (0x4685 start {u32 count} / 0x4686 items /
  0x4687 end {u32 count}). Requested with the u32 entry id of a 0x4682 list row. Records
  packed back to back, parser 0xd3b42c reads to end of payload; client table caps at 32,
  93 bytes each on the wire (struct stride 0x60).
