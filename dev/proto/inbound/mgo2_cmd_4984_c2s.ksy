meta:
  ...
  title: "MGO2 0x4984 \u2014 game lobby request (one u4) (client -> server)"
  endian: be
doc: |
  Sender `0xD4A578`, builder call `0xD4A5EC`, subsystem index `0x3F` (`li r4,63` after the send).
  Unhandled. Single u32 from the sender's r4 argument (`stw 1416(r1)` at `0xD4A5A4`).
...
seq:
  - id: unknown_00
    type: u4
    doc: "[ELF] `0xD5C9BC` at `0xD4A5FC`, source = sender arg r4. Meaning [UNKNOWN]."
