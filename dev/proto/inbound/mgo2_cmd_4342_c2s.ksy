meta:
  id: mgo2_cmd_4342_c2s
  title: "MGO2 0x4342 — peer register (client -> server)"
  endian: be
doc: |
  Builder function `0xD43100`; `bl 0xD5CF40` at `0xD431AC` (`li r4,0x4342` at `0xD431A8`).
  One payload write — `0xD5C9BC` (u32) at `0xD431BC` — then the seal `0xD5C828`
  at `0xD431C8` and the flush `0xD34CC0` at `0xD431D8`. Not encrypted.
...
seq:
  - id: chara_id
    ...
    doc: |
      ...
      (`0x43A0`, `0x43A6`, `0x43C4`) carries a character id; nothing in `0xD43100`
