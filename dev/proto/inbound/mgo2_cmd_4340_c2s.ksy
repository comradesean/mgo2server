meta:
  id: mgo2_cmd_4340_c2s
  title: "MGO2 0x4340 — peer register (client -> server)"
  endian: be
doc: |
  Builder function `0xD43244`; `bl 0xD5CF40` at `0xD432F0` (`li r4,0x4340` at `0xD432EC`).
  One payload write — `0xD5C9BC` (u32) at `0xD43300` — then the seal `0xD5C828`
  at `0xD4330C` and the flush `0xD34CC0` at `0xD4331C`. Not encrypted.
...
seq:
  - id: chara_id
    ...
    doc: |
      ...
      (`0x43A0`, `0x43A6`, `0x43C4`) carries a character id; nothing in `0xD43244`
