...
doc: |
  ...
  Unhandled. Single u8 from the sender's r4 argument (`stb 1432(r1)` at `0xD4DBB8`).
  No value guard, unlike `0x4930`. Total payload: 1 byte.
...
seq:
  - id: unknown_00
    type: u1
    doc: "[ELF] `0xD5C8A0` at `0xD4DC80`, source = sender arg r4. Meaning [UNKNOWN]."
