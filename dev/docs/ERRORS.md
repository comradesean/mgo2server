...
Generated by `dev/tools/trace_dialog_paths.py`, which runs each of the dispatcher's
`cmpwi` chains concretely once per candidate result code (-4096..256)
...
The arms below are the 31 entries of the jump table at `0xA7DE74`,
...
### Arm 0 — Unable to acquire clan information  <sub>0xA7E3B4</sub>
...
### Arm 1 — Unable to acquire clan information  <sub>0xA7E3B4</sub>
...
| code | string | message |
| --- | --- | --- |
| `-1230` | 24065 | Use of the clan emblem is currently forbidden. |
| `-1215`..`-1214` | — | _(no dialog raised — the code is stored and the screen does not respond)_ |
| `-1207` | 23970 | Unable to locate designated clan. |
| `-160` | 24376 | A network server error has occurred.\nUnable to acquire clan emblem. |
| _(any other)_ | 24370 | Unable to acquire clan emblem. |

### Arm 3 — Unable to acquire clan emblem  <sub>0xA7E394</sub>
...
### Arm 4 — Unable to acquire clan emblem  <sub>0xA7E394</sub>
...
### Arm 5 — Unable to acquire clan information  <sub>0xA7E3B4</sub>
...
### Arm 6 — Unable to acquire clan information  <sub>0xA7E3B4</sub>
...
### Arm 7 — Unable to acquire clan roster  <sub>0xA7E3FC</sub>

| code | string | message |
| --- | --- | --- |
| `-1207` | 23970 | Unable to locate designated clan. |
| _(any other)_ | 24346 | Unable to acquire clan roster. |

### Arm 8 — Unable to acquire clan list  <sub>0xA7E524</sub>

| code | string | message |
| --- | --- | --- |
| `-1207` | 23970 | Unable to locate designated clan. |
| `-160` | 24364 | A network server error has occurred.\nUnable to acquire clan list. |
| _(any other)_ | 24358 | Unable to acquire clan list. |

### Arm 9 — Unable to acquire clan entry application list  <sub>0xA7E6B8</sub>

| code | string | message |
| --- | --- | --- |
| `-1207` | 23982 | You are not a clan member. |
| `-1203` | 23988 | You are not clan leader. |
| `-1202` | 23982 | You are not a clan member. |
| `-160` | 24394 | A network server error has occurred.\nUnable to acquire clan entry application list. |
| _(any other)_ | 24388 | Unable to acquire clan entry application list. |

### Arm 10 — Unable to acquire character information  <sub>0xA7E554</sub>

| code | string | message |
| --- | --- | --- |
| `-266` | 22475 | Designated character has been deleted and no longer exists. |
| `-160` | 22907 | A network server error has occurred.\nUnable to acquire character information. |
| _(any other)_ | 22901 | Unable to acquire character information. |

### Arm 11 — Unable to acquire character information  <sub>0xA7E554</sub>
...
### Arm 12 — Unable to update clan information  <sub>0xA7E584</sub>
...
| `-1203` | 23988 | You are not clan leader. |
| `-1202` | 23982 | You are not a clan member. |
| `-160` | 24095 | A network server error has occurred.\nUnable to update clan information. |
| _(any other)_ | 24089 | Unable to update clan information. |

### Arm 13 — Unable to update character information  <sub>0xA7E608</sub>

| code | string | message |
| --- | --- | --- |
| `-160` | 22871 | A network server error has occurred.\nUnable to update character information. |
| _(any other)_ | 22865 | Unable to update character information. |

### Arm 14 — Unable to search for clan  <sub>0xA7E62C</sub>

| code | string | message |
| --- | --- | --- |
| `-611` | 22613 | Too many search results have been found. Only a portion of the results will be shown.\n |
| `-160` | 24469 | A network server error has occurred.\nUnable to search for clan. |
| `-24` | 22607 | Search field does not contain enough characters.\nField text must be between 3 and 15 characters. |
| _(any other)_ | 24463 | Unable to search for clan. |

### Arm 15 — Unable to approve entry application  <sub>0xA7E6FC</sub>

| code | string | message |
| --- | --- | --- |
| `-1210` | 24197 | The applicant has already canceled their clan entry application. |
| `-1207` | 23982 | You are not a clan member. |
| `-1203` | 23988 | You are not clan leader. |
| `-1202` | 23982 | You are not a clan member. |
| `-160` | 24191 | A network server error has occurred.\nUnable to approve entry application. |
| _(any other)_ | 24185 | Unable to approve entry application. |

### Arm 16 — Unable to decline entry application  <sub>0xA7E724</sub>
...
| `-1203` | 23988 | You are not clan leader. |
| `-1202` | 23982 | You are not a clan member. |
| `-160` | 24209 | A network server error has occurred.\nUnable to decline entry application. |
| _(any other)_ | 24203 | Unable to decline entry application. |

### Arm 17 — An error has occurred  <sub>0xA7E5A0</sub>

| code | string | message |
| --- | --- | --- |
| `-160` | 21917 | A network server error has occurred. |
| _(any other)_ | 21905 | An error has occurred. |

### Arm 18 — Unable to assign emblem editing rights  <sub>0xA7E6D4</sub>

| code | string | message |
| --- | --- | --- |
| `-1208` | 24268 | Designated player has already left clan.\nUnable to assign emblem editing rights. |
| `-1207` | 23982 | You are not a clan member. |
| `-1203` | 23988 | You are not clan leader. |
| `-1202` | 23982 | You are not a clan member. |
| `-160` | 24256 | A network server error has occurred.\nUnable to assign emblem editing rights. |
| _(any other)_ | 24250 | Unable to assign emblem editing rights. |

### Arm 19 — Unable to revoke emblem editing rights  <sub>0xA7E5C4</sub>
...
| `-1203` | 23988 | You are not clan leader. |
| `-1202` | 23982 | You are not a clan member. |
| `-160` | 24280 | A network server error has occurred.\nUnable to revoke emblem editing rights. |
| _(any other)_ | 24274 | Unable to revoke emblem editing rights. |

### Arm 20 — Unable to assign new leader  <sub>0xA7E5E0</sub>

| code | string | message |
| --- | --- | --- |
| `-1208` | 24304 | Designated player has already left clan.\nUnable to assign new leader. |
| `-1207` | 23982 | You are not a clan member. |
| `-1203` | 23988 | You are not clan leader. |
| `-1202` | 23982 | You are not a clan member. |
| `-160` | 24292 | A network server error has occurred.\nUnable to assign new leader. |
| _(any other)_ | 24286 | Unable to assign new leader. |

### Arm 21 — Unable to banish clan member  <sub>0xA7E658</sub>

| code | string | message |
| --- | --- | --- |
| `-1208` | 24322 | Designated player has already left clan.\nUnable to banish clan member. |
| `-1207` | 23982 | You are not a clan member. |
| `-1203` | 23988 | You are not clan leader. |
| `-1202` | 23982 | You are not a clan member. |
| `-160` | 24316 | A network server error has occurred.\nUnable to banish clan member. |
| _(any other)_ | 24310 | Unable to banish clan member. |

### Arm 22 — `0x4b01 — create clan`  <sub>0xA7E680</sub>
...
| _(any other)_ | 24024 | Unable to create clan. |

### Arm 23 — `0x4b05 — disband clan`  <sub>0xA7E74C</sub>
...
| `-1203` | 23988 | You are not clan leader. |
| `-1202` | 23982 | You are not a clan member. |
| `-160` | 24334 | A network server error has occurred.\nUnable to disband clan. |
| _(any other)_ | 24328 | Unable to disband clan. |

### Arm 24 — Unable to update clan comment  <sub>0xA7E770</sub>

| code | string | message |
| --- | --- | --- |
| `-1231` | 24227 | Clan comment contains an invalid word.\nUnable to update clan comment. |
| `-1207` | 23982 | You are not a clan member. |
| `-1203` | 23988 | You are not clan leader. |
| `-1202` | 23982 | You are not a clan member. |
| `-160` | 24221 | A network server error has occurred.\nUnable to update clan comment. |
| _(any other)_ | 24215 | Unable to update clan comment. |

### Arm 25 — `0x4b51 — set clan emblem`  <sub>0xA7E410</sub>
...
| _(any other)_ | 24400 | Unable to update clan emblem. |

### Arm 26 — Unable to update clan notice  <sub>0xA7E508</sub>

| code | string | message |
| --- | --- | --- |
| `-1232` | 24245 | Clan notice contains an invalid word.\nUnable to update clan notice. |
| `-1207` | 23982 | You are not a clan member. |
| `-1202` | 23982 | You are not a clan member. |
| `-160` | 24239 | A network server error has occurred.\nUnable to update clan notice. |
| _(any other)_ | 24233 | Unable to update clan notice. |

### Arm 27 — Unable to leave clan  <sub>0xA7E480</sub>

| code | string | message |
| --- | --- | --- |
| `-1207` | 23982 | You are not a clan member. |
| `-1202` | 23982 | You are not a clan member. |
| `-160` | 24179 | A network server error has occurred.\nUnable to leave clan. |
| _(any other)_ | 24173 | Unable to leave clan. |

### Arm 28 — not analysed  <sub>0xA7E4A8</sub>

This chain is not a pure function of the result code — it calls out and reloads the
code from memory, so the tracer declined it rather than guessing. (call to 0x2810e0)


### Arm 29 — `0x4b43 — apply to join clan`  <sub>0xA7E43C</sub>
...
### Arm 30 — Unable to cancel clan entry  <sub>0xA7E45C</sub>

| code | string | message |
| --- | --- | --- |
| `-160` | 24167 | A network server error has occurred.\nUnable to cancel clan entry. |
| _(any other)_ | 24161 | Unable to cancel clan entry. |

## What else raises a dialog

The tracer also sweeps the rest of the binary, so the reach of the list above is measured
rather than assumed. There are **198** call sites of `0x885A08` in the image.
They divide up like this.

**85 report a fixed code.** The instruction before the call is
...
**56 raise the same dialogId whatever the code.** The code is carried
...
**3 are inline chains that do discriminate**, outside any jump table
...
### The network-error twin  <sub>0xA7ED30</sub>

A second 31-arm table sits beside the first and is indexed by the same operation
ordinal. Every one of its 30 live arms is fixed: it raises that operation's *"A network
...
17 rows resolve to a string id that carries no text. Those are real ids, not decode
